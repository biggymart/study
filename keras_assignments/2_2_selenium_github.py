...
# chromedriver = r'C:/Users/ai/Downloads/chromedriver_win32.exe'
# chromedriver = r'C:/Study/chromedriver_win32.exe'
...
def download_google_staticimages():
    ...
    try:
        browser = webdriver.Chrome(executable_path='C:/Users/ai/Downloads/chromedriver_win32.exe', options=options)

...
def create_hyperparameters() :
    ...
    return {"batche_size" : batches, "drop1" : dropout1, "node1" : node1, "node2" : node2, \
...
def create_hyperparameters() :
    ...
    kernel_size2 = [2, 3]  
    kernel_size3 = [2, 3] 
    return {"optimizer" : optimizers, "drop2" : dropout2, "drop3" : dropout3, \
        "kernel1" : kernel_size1, "kernel2" : kernel_size2, "kernel3" : kernel_size3}
...
# best_params :  {'optimizer': 'adam', 'kernel3': 2, 'kernel2': 2, 'kernel1': 3, \
#     'drop3': 0.3, 'drop2': 0.2}

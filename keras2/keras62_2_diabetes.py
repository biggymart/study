...
model2 = KerasRegressor(build_fn=build_model, verbose=1) # epochs=3, validation_split=0.2) # also works here as well
...
# Final score:  -3148.765380859375
# {'optimizer': 'rmsprop', 'node': 512, 'drop': 0.2, 'batch_size': 20}
# <tensorflow.python.keras.wrappers.scikit_learn.KerasRegressor object at 0x000001F1241D5100>
# -3062.317529296875
# RandomizedSearchCV, GridSearchCV와 Pipeline을 엮어라
# 사용 모델: RandomForest

# 1st Option: MinMaxScaler / StandardScaler
# 2nd Option: Pipeline / make_pipeline -> appropriately modify parameter names
# 3rd Option: GridSearchCV / RandomizedSearchCV

...
model = RandomizedSearchCV(RandomForestClassifier(), parameters, cv=kfold) ### Takeaway3 ###
...
# 최적의 매개변수: RandomForestClassifier(max_depth=10, min_samples_leaf=3, min_samples_split=3, n_estimators=200, n_jobs=-1)

...
# KNeighborsClassifier() scores :   [0.91 0.96 0.96 0.9  0.93]
# DecisionTreeClassifier() scores : [0.88 0.96 0.92 0.95 0.93]
# RandomForestClassifier() scores : [0.95 1.   0.96 0.95 0.97]
# LogisticRegression() scores :     [0.95 0.95 0.96 0.88 0.96]
# LinearSVC() scores :              [0.9  0.95 0.96 0.88 0.95]
# SVC() scores :                    [0.88 0.98 0.92 0.89 0.9 ]
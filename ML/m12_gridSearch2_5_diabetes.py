...
model = GridSearchCV(RandomForestRegressor(), parameters, cv=kfold) ### Takeaway3 ###
...
# 최적의 매개변수: RandomForestRegressor(max_depth=10, min_samples_leaf=3, min_samples_split=3, n_jobs=-1)
# 최종정답률: 0.3653879961439589
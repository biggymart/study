...
# 데이터 로드
train = pd.read_csv('C:/data/mnist/mnist_data/train.csv')
print(train.shape)  # (2048, 787)

sub = pd.read_csv('C:/data/mnist/mnist_data/submission.csv')
print(sub.shape) # (20480, 2)

test = pd.read_csv('C:/data/mnist/mnist_data/test.csv')
...
print(sub)
sub.to_csv('C:/data/mnist/mnist_data/private3.csv', index=False)
...
caltech_dir =  'C:/data/LPD_competition/train'
categories = []
...
np.save("../data/LPD_competition/npy/Lotte_train_x5.npy", arr=X)
np.save("../data/LPD_competition/npy/Lotte_train_y5.npy", arr=y)

...
get_ipython().system('cp "/content/drive/MyDrive/월간데이콘 12/data/open/data_2.zip" "data_2.zip"')
...
get_ipython().system('unzip "dirty_mnist.zip" -d "./dirty_mnist/"')
...
get_ipython().system('unzip "test_dirty_mnist.zip" -d "./test_dirty_mnist/"')
# 출력 결과 지우기
output.clear()

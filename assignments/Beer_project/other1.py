...
for image in images : 
    try : 
        image.click() 
        time.sleep(10)
        imgUrl = driver.find_element_by_xpath("/html/body/div[2]/c-wiz/div[3]/div[2]/div[3]/div/div/div[3]/div[2]/c-wiz/div/div[1]/div[1]/div/div[2]/a/img").get_attribute("src")    # 다운받을 이미지 창 띄우기

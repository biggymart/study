# 2개의 모델을 하나는 LSTM, 하나는 DNN으로 앙상블 만들고 성능비교
# x1을 DNN, x2를 LSTM으로 해보자
...
# x1_train = x1_train.reshape(x1_train.shape[0], x1_test.shape[1], 1) 
# x1_test = x1_test.reshape(x1_test.shape[0], x1_test.shape[1], 1)
x2_train = x2_train.reshape(x2_train.shape[0], x2_train.shape[1], 1) # LSTM용 데이터로 가공
x2_test = x2_test.reshape(x2_test.shape[0], x2_test.shape[1], 1) # LSTM용 데이터로 가공
...
y1_predict = model.predict([x1_predict, x2_pred])
print("y1_predict :\n", y1_predict, sep='')
...
# 결과 keras29_LSTM_ensemble2_differ
# 'loss', 'mae':[0.22415293753147125, 0.3058195114135742]
# y1_predict : [[72.51766]]
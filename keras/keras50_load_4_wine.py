...
hist = model.fit(x_train, y_train, epochs=10000, validation_split=0.2, callbacks=[early_stopping, check_point])
...
# 결과
# [categorical_crossentropy, acc] : [1.1167997121810913, 0.5555555820465088]
# 1
# 2
# 1
# 1

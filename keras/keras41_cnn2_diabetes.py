...
x_val = x_val.reshape(-1, x_val.shape[1], 1, 1)

#2. model
from tensorflow.keras import Model
from tensorflow.keras.layers import Input, Dense, Dropout, Conv2D, MaxPool2D, Flatten
input1 = Input(shape=(x.shape[1], 1, 1))
dense1 = Conv2D(200, (2,2), padding='same', activation='relu')(input1)
dense1 = MaxPool2D((2,2), padding='same')(dense1)
...
# 결과
# mse : 4569.7958984375
# mae : 49.697513580322266
# RMSE : 67.60026013934976
# R2 : 0.14246188547122218